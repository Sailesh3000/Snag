...
const BENEFITS = [
  "AI answers tailored to your profile",
  "Static fields auto-filled instantly",
  "Your answers remembered across applications",
];
        ...
        <GateCard>
          <div className="space-y-1.5">
            ...
            <p className="text-[10px] text-gray-500 leading-relaxed">
              One account for your profile, your past answers, and your subscription. Snag is free while in
              early access — your data stays on this device.
            </p>
          </div>
        ...
        <GateCard>
          <div className="space-y-1.5">
            <div className="flex items-center gap-1.5">
              ...
              <h2 className="text-[13px] font-bold text-white">Snag Pro — $10/month</h2>
            </div>
            <p className="text-[10px] text-gray-500 leading-relaxed">
              Signed in as <span className="text-gray-300 font-mono">{auth.session?.email}</span>. Subscribe to
              unlock AI answers for this application.
            </p>
          </div>
